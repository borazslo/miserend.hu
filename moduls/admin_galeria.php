...
function galeria_add($gid) {
	...
	$urlap.="\n<br><br><span class=kiscim>Bevezető szöveg: </span><br><textarea name=intro class=urlap cols=60 rows=20>$intro</textarea>";
...
function galeria_del() {
	...
	$kiir="\n<span class=kiscim>Biztosan törölni akarod a következő galériát?</span>";
