...
function szavazas_add($kid) {
	...
	$urlap.="\n<br><br><span class=kiscim>Fõoldalak: </span><br><span class=alap>Mely fõoldal(ak)on legyen ez a szavazás? Több is választható!</span><br><select name=fooldalT[] multiple class=urlap>";
...
function szavazas_del() {
	...
	$kiir="\n<span class=kiscim>Biztosan törölni akarod a következõ szavazást?</span>";
