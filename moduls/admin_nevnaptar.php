...
function nevnaptar_index($honap,$ev) {
    ...
    for($szamlalo=0;$szamlalo<42;$szamlalo++) {
        ...
        if($szamlalo<$elsoNapTombje["wday"] || $napTomb["mon"] != $honap) {
            ...
            //Ellenőrizzük, hogy az óraállításoknál ne legyen kétszer ugyanaz a nap!
	...
	$szoveg.="<div align=left><a href=?m_id=$m_id&ev=$kovev&honap=$kovhonap$linkveg class=link>Következő hónap</a></div";
