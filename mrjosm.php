...
//poligon középpontot keresünk 60 méteres körzetben  
            ...
            if (pg_num_rows($pont) || pg_num_rows($poly) > 0) {
                ...
                echo '<tr><td>-</td><td>-</td><td>-</td><td>' . $kk[0] . '</td><td>' . $kk[1] . '</td><td>-</td><td><a href="http://localhost:8111/add_node?lon=' . $kk[4] . '&lat=' . $kk[5] . '&addtags=name=' . $kk[0] . '%7Calt_name=' . $kk[1] . '%7Cdenomination=' . $kk[2] . '%7Curl:miserend=' . $kk[3] . '%7Creligion=christian%7Camenity=place_of_worship" target="_blank">hozzáad</a></td></tr>';
            }
        } else {
            echo '<tr><td>-</td><td>-</td><td>-</td><td>' . $kk[0] . '</td><td>' . $kk[1] . '</td><td>-</td><td>Nincs koordináta <a href="' . $kk[3] . '" target="_blank">' . $kk[3] . '</a></td></tr>';
        }
    }
    ...
    echo 'Így nem megy...<br>Így működik:http://data2.openstreetmap.hu/mrjosm.php?miserend=100 <br>A szám 1-101 közt lehet.';
}
?>
