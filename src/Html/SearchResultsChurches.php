...
class SearchResultsChurches extends Html {
    ...
    public function __construct() {
        ...
        $search = \App\Model\Church::where('ok', 'i');
		...
		$selectReligiousAdministration = \App\Form::religiousAdministrationSelection(['diocese' => isset($_REQUEST['ehm']) ? $_REQUEST['ehm'] : false , 'deanery' => isset($_REQUEST['espker']) ? $_REQUEST['espker'] : false ]);
        ...
        $this->churches = \App\Model\Church::whereIn('id', $churchIds)->get();
    }
