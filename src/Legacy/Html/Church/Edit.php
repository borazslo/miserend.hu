...
class Edit extends \App\Legacy\Html\Html
{
        ...
        if (isset($this->input['church']['osm'])) {
            ...
            foreach ($allowedOSMFields as $field) {
                if (\array_key_exists($field, $this->input['church']['osm'])) {
                    ...
                    $osmtag = \App\Legacy\Model\OSMTag::firstOrNew($args);
    ...
    public function addFormReligiousAdministration()
    {
        ...
        $selectReligiousAdministration = \App\Legacy\Form::religiousAdministrationSelection($selected);
