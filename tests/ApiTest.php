    ...
    public function providerTestApiUser()
    {
        return array(
            ...
            array(
                ...
                array(
                    'error' => 0,
                    'user' => array('username' => 'vacskamati', 'nickname' => '', 'name' => 'Lázár Ervin', 'email' => 'egyik@gmail.com'),
                ),
            ),
        );
    }
        ...
        return array(
            ...
            array(
                ...
                array(
                    ...
                    'tid' => 138,
                    'pid' => 2,
                    'text' => 'Ez egy teszt megjegyzés. "dbdate" is van. Elnézést.',
                    'dbdate' => "-2 years",
                ),
                array('error' => 1),
            ),
    ...
    public function providerTestApiTable()
    {
        return array(
            ...
            array(
                ...
                array(
                    'templomok' => array(
                        array('id' => '138', 'nev' => 'Szent Anna templom', 'ismertnev' => 'Szabadhegyi templom',),
                        array('id' => '139', 'nev' => 'Loyolai Szent Ignác-templom', 'ismertnev' => 'Bencés templom',),
                    ),
                    'error' => 0,
                ),
            ),
