...
function keret($helyzet) {
	...
	$tablabgT=array('#FBF7EC','#F6EDDC','#D1DDE9');
	$fejlecbgT=array('#F1A25B','#D2B164','#053D78');
...
function design() {
    global $design_url,$db_name,$tartalom,$m_oldalsablon,$balkeret,$jobbkeret,$onload,$sid,$linkveg,$u_id,$u_login,$u_jogok,$belepve,$loginhiba,$script;
...
////////////////////////////////////////////
	...
	$emaillink_lablec="<A HREF=\"javascript:linkTo_UnCryptMailto('ocknvq%3CkphqBjktrqtvc0jw');\" class=emllink>info<img src=img/kukaclent.gif align=absmiddle border=0>hirporta.hu</a>";
