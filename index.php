...
/////////////////////////////////
//Ellenõrzések, beállítások
/////////////////////////////////
    if(!@include_once('ell.php')) {
        $hiba=true;
        $hibauzenet_prog.='<br>HIBA! Az ellenõrzõ fájl behívásakor!';
    }
...
/////////////////////////////////
    if(!$hiba) {
        if(!include("$design_url/design.php")) {
            $hiba=true;
            $hibauzenet.='Elnézését kérjük, az oldal nem jeleníthetõ meg.';
...
/////////////////////////////////
    ...
    //Nincs belépve, kirakjuk az ûrlapot
...
/////////////////////////////////
//html kód kiküldése a böngészõnek
/////////////////////////////////
    print $html_kod;
